...
- 기초문법2
    - 기초문법2 (함수,전처리기,지역변수,비트연산...) : [[조건문공부]([./basic/data/data/data2.cpp](https://github.com/Owl-jun/CPPbasic2025/blob/main/basic/data/data/data2.cpp))]
...
- 기초
    - 유용한 단축키 , 디버깅 단축키 , 함수&재귀함수 , 배열 : [[CPP]]([./basic/data/data/func.cpp](https://github.com/Owl-jun/CPPbasic2025/blob/main/basic/data/data/func.cpp))
